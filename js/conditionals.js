...
var billMessage = "Your lucky number is " + luckyNumber + " and the final cost is " + totalBillDollars;
//alert(billMessage)
...
var willEnterNumber = confirm("Do you want to enter a numbner?");

if (willEnterNumber) {
    // do the number things

    // get the user input and store in a variable
...
//  }
//
// var userShirtColor = prompt("What color is your shirt?");
// var returnMessage = analyzeColor(userShirtColor);
// alert(returnMessage);
